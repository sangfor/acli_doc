...
```bash
-d|--domain-id=string    Required parameter, Network plane ID (UUID), used to filter flow-control configs by network plane, e.g. 960d7a90-aad3-4f5c-b57f-5e3f61098ae2
```
