...
-l|--log=string        Query logs of specified types. Value can be any value. Example: error, selftest
-d|--device=string     Specify device type. Value can be any value. Example: scsi
