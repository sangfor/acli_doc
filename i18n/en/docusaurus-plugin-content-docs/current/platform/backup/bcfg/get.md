...
View the backup point config file \{$vmid\}.conf.bcfg content

### Command Parameters
```bash
-s|--storage-name=string    Required parameter, Specify the name of the storage where the backup file to be queried is located, for example: NFS-1
-v|--vm-id=string           Required parameter, Specify the vmid corresponding to the backup file you want to query, for example: 5050155340046
-b|--backup-id=string       Specify the id of the backup file to query, example: auto-260130-122446-cd61f44d-4d55-4218-945a-f858d75702c4
```
