...
查看备份点配置文件\{$vmid\}.conf.bcfg内容

### 命令参数

```bash
-s|--storage-name=string    必要参数，指定要查询的备份文件所在的存储的名称，示例：NFS-1
-v|--vm-id=string           必要参数，指定要查询的备份文件对应的虚拟机id，示例：5050155340046
-b|--backup-id=string       指定要查询的备份文件的id，示例：auto-260130-122446-cd61f44d-4d55-4218-945a-f858d75702c4
```
