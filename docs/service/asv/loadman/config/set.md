...
-m|--master-cores=integer       可选参数，主控节点隔离核数，非负整数，0表示不设置，最大不超过主机核数的80%
--controller-cores=integer      可选参数，从控节点隔离核数，非负整数，0表示不设置，最大不超过主机核数的80%
--compute-cores=integer         可选参数，计算节点隔离核数，非负整数，0表示不设置，最大不超过主机核数的80%
```
